...
public partial class EaglesOracleContext : DbContext
{
    ...
    public virtual DbSet<MvCourseSection> MvCourseSections { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<InventoryState>(entity =>
        {
            ...
            entity.Property(e => e.InventoryStateId).ValueGeneratedOnAdd();
        ...
        modelBuilder.Entity<InventoryStatus>(entity =>
        {
            ...
            entity.Property(e => e.InventoryStatusId).ValueGeneratedOnAdd();
        ...
        modelBuilder.Entity<MvCourseSection>(entity =>
        {
            entity.ToView("MV_COURSE_SECTION");
        });
        ...
        {
            entity.HasKey(e => e.OrdersLineId).HasName("ORDERS_LINE_ID");
